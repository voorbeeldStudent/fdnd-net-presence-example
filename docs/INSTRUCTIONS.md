...
Na het volgen van deze opdracht heb je een beginnend idee van het samenspel tussen HTML (voor de structuur), CSS (voor de vormgeving) en Javascript (voor de interactie), en een beginnend idee van de ontwerpprincipes die betrokken zijn bij het maken van een eenvoudig online visitekaartje.
